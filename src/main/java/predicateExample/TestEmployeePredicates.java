...
public class TestEmployeePredicates {
    public static void main(String[] args){
        ...
        System.out.println( employees.stream().filter(employee -> employee.getGender().equals("F")).collect(Collectors.toList()));

        System.out.println(employees.stream().filter(employee -> employee.getGender().equals("M")).collect(Collectors.toList()));
